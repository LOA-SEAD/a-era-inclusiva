...
namespace Lean.Touch
{
    ...
    public class LeanSpawn : MonoBehaviour
    {
        ...
        [Space] [Tooltip("This allows you to offset the finger position.")]
        ...
        [Space] [Tooltip("This allows you to offset the spawned object position.")]
        ...
        protected bool TrySpawn(LeanFinger finger, ref Transform instance)
        {
            if (Prefab != null && finger != null)
            {
                ...
                if (selectable != null) selectable.Select(finger);
