    ...
    public class LeanSelectableRendererColor : LeanSelectableBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            if (AutoGetDefaultColor)
            {
                ...
                if (material0 != null) DefaultColor = material0.color;
            }

            if (CloneMaterials) cachedRenderer.sharedMaterials = cachedRenderer.materials;
        }
        ...
        private void ChangeColor(Color color)
        {
            ...
            for (var i = materials.Length - 1; i >= 0; i--) materials[i].color = color;
        }
    }
}