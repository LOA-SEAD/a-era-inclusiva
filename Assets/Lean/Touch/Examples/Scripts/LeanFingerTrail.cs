...
namespace Lean.Touch
{
    ...
    public class LeanFingerTrail : MonoBehaviour
    {
        ...
        {
            // ignore?
            if (MaxLines > 0 && fingerDatas.Count >= MaxLines) return;
            ...
            // Create line?
            if (fingerData.Line == null) fingerData.Line = Instantiate(LinePrefab);
        ...
        private void FingerUp(LeanFinger finger)
        {
            ...
            if (fingerData != null)
            {
                ...
                if (fingerData.Line != null) Destroy(fingerData.Line.gameObject);
            }
        }
