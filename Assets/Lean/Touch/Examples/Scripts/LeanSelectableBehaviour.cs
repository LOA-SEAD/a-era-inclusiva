...
{
	/// <summary>
	///     This is the base class for all components that need to implement some kind of special logic when selected. You
	///     can do this manually without this class, but this makes it much easier.
	/// </summary>
