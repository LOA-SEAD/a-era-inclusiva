...
namespace Lean.Touch
{
    ...
    public class LeanTouch : MonoBehaviour
    {
        ...
        ///     within the 'TapThreshold' time) (LeanFinger = The current finger)
        /// </summary>
        ...
        /// <summary>
        ///     This gets fired after a finger has stopped touching the screen for more than TapThreshold seconds, and is
        ///     removed from both the active and inactive finger lists.
        /// </summary>
        public static Action<LeanFinger> OnFingerExpired;
