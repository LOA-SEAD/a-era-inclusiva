...
namespace Lean.Common.Examples
{
    ...
    public class LeanDocumentation_Inspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("The documentation is in HTML format. You can open it by clicking below.",
                bodyStyle);

            if (GUILayout.Button(new GUIContent("Local Documentation", "Open In Web Browser")))
            {
                var path = Path.Combine(Application.temporaryCachePath, Target.Link + ".html");

                Debug.Log("Generating and opening documentation in: " + path);

                File.WriteAllText(path, Target.HTML);
            ...
            EditorGUILayout.LabelField("If you read the documentation and still have questions, feel free to ask!",
                bodyStyle);
            ...
            if (string.IsNullOrEmpty(Target.YouTube) == false)
                if (GUILayout.Button(new GUIContent("YouTube Channel", "YouTube")))
            ...
            EditorGUILayout.LabelField(
                "If you haven't already, please consider rating this asset. It really helps me out!", bodyStyle);

            if (GUILayout.Button(new GUIContent("Rate This Asset", Target.Title + " Asset Page")))
            ...
            EditorGUILayout.LabelField(
                "If you've finished a project using " + Target.Title +
                " then let me know! I can shout you out, link to you from my website, and much more!", bodyStyle);
        ...
        protected override void OnHeaderGUI()
        {
            ...
            GUILayout.BeginHorizontal("In BigTitle");
            {
                ...
                if (Target.Icon != null)
                    GUILayout.Label(Target.Icon, EditorStyles.centeredGreyMiniLabel, GUILayout.Width(iconWidth),
